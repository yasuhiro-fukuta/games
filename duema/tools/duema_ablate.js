...
const FLAGS = process.argv[9] ? JSON.parse(process.argv[9]) : null;
(async () => {
  ...
  await page.evaluate(([depth, budget, SW, FLAGS]) => {
    STRONG_W = SW;
    if (FLAGS) Object.assign(SENSEI_FLAGS, FLAGS);
